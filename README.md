 ...
 * @LastEditTime: 2024-05-28 09:53:01
 * @License: GPL 3.0
-->
...
| ------  | ------  | ------ | ------ | 
| [Deep Sleep Wake Up](./examples/Deep_Sleep_Wake_Up) | `[Platformio IDE][espressif 32-v6.5.0]`<br />`[Arduino IDE][esp32_v3.0.0-rc3]` |  |  |
| [Original Test](./examples/Original_Test) | `[Platformio IDE][espressif 32-v6.5.0]`<br />`[Arduino IDE][esp32_v3.0.0-rc3]` | Product factory original testing |  |
| [Wifi STA](./examples/Wifi_STA) | `[Platformio IDE][espressif 32-v6.5.0]`<br />`[Arduino IDE][esp32_v3.0.0-rc3]` |  |  |
